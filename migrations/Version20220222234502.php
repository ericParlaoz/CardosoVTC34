 ...
 */
final class Version20220222234502 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE clients ADD confidentialite TINYINT(1) NOT NULL');
    }
