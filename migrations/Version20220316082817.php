 ...
 */
final class Version20220316082817 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE clients ADD infos VARCHAR(255) DEFAULT NULL');
    }
